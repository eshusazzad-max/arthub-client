...
export default function ArtworkCard({ artwork }: any) {
  return (
    ...
    >
      ...
      <div className="p-6">
        {/* Category */}
        <span className="inline-block px-3 py-1.5 rounded-full bg-violet-500/20 text-violet-600 dark:text-violet-300 text-xs font-medium">
          {artwork.category}
        </span>
        ...
        {/* Description */}
        <p className="text-slate-500 dark:text-gray-500 text-sm leading-8 mt-5">
          {artwork.description}
        </p>

        {/* Bottom */}
        <div className="border-t border-slate-400 dark:border-white/10 mt-8 pt-8 flex items-center justify-between">
          {/* Price */}
          <p className="text-cyan-500 dark:text-cyan-400 text-2xl font-bold">
            ${artwork.price}
          </p>
